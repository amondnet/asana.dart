...
part 'custom_field_response.g.dart';

abstract class CustomFieldResponse implements Built<CustomFieldResponse, CustomFieldResponseBuilder> {
    ...
    CustomFieldResponse._();

    factory CustomFieldResponse([updates(CustomFieldResponseBuilder b)]) = _$CustomFieldResponse;
    static Serializer<CustomFieldResponse> get serializer => _$customFieldResponseSerializer;
