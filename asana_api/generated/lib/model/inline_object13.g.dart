...
class _$InlineObject13 extends InlineObject13 {
  ...
  _$InlineObject13._({this.data}) : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is InlineObject13 && data == other.data;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InlineObject13')..add('data', data))
        .toString();
  }
}
...
class InlineObject13Builder
  ...
  _$InlineObject13 build() {
    ...
    try {
      _$result = _$v ?? new _$InlineObject13._(data: _data?.build());
    } catch (_) {
