    ...
    if (object.data != null) {
      result
        ...
        ..add(serializers.serialize(object.data,
            specifiedType: const FullType(ProjectSectionInsertRequest)));
    }
    return result;
  }
      ...
      switch (key) {
        case 'data':
          result.data.replace(serializers.deserialize(value,
                  specifiedType: const FullType(ProjectSectionInsertRequest))
              as ProjectSectionInsertRequest);
          break;
      }
    }
...
class _$InlineObject30 extends InlineObject30 {
  ...
  bool operator ==(Object other) {
    ...
    return other is InlineObject30 && data == other.data;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InlineObject30')..add('data', data))
        .toString();
  }
}
...
class InlineObject30Builder
  ...
  ProjectSectionInsertRequestBuilder _data;
  ProjectSectionInsertRequestBuilder get data =>
      _$this._data ??= new ProjectSectionInsertRequestBuilder();
  set data(ProjectSectionInsertRequestBuilder data) => _$this._data = data;
  ...
  _$InlineObject30 build() {
    ...
    try {
      _$result = _$v ?? new _$InlineObject30._(data: _data?.build());
    } catch (_) {
