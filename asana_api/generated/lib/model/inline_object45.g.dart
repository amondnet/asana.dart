    ...
    if (object.data != null) {
      result
        ...
        ..add(serializers.serialize(object.data,
            specifiedType: const FullType(TaskRemoveProjectRequest)));
    }
    return result;
  }
...
class _$InlineObject45 extends InlineObject45 {
  ...
  bool operator ==(Object other) {
    ...
    return other is InlineObject45 && data == other.data;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InlineObject45')..add('data', data))
        .toString();
  }
}
...
class InlineObject45Builder
  ...
  TaskRemoveProjectRequestBuilder _data;
  TaskRemoveProjectRequestBuilder get data =>
      _$this._data ??= new TaskRemoveProjectRequestBuilder();
  set data(TaskRemoveProjectRequestBuilder data) => _$this._data = data;
  ...
  _$InlineObject45 build() {
    ...
    try {
      _$result = _$v ?? new _$InlineObject45._(data: _data?.build());
    } catch (_) {
