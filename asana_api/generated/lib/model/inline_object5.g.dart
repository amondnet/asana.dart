...
class _$InlineObject5 extends InlineObject5 {
  ...
  _$InlineObject5._({this.data}) : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is InlineObject5 && data == other.data;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InlineObject5')..add('data', data))
        .toString();
  }
}
...
class InlineObject5Builder
  ...
  _$InlineObject5 build() {
    ...
    try {
      _$result = _$v ?? new _$InlineObject5._(data: _data?.build());
    } catch (_) {
