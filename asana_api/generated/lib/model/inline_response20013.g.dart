      ...
      result
        ...
        ..add(serializers.serialize(object.data,
            specifiedType: const FullType(
                BuiltList, const [const FullType(ProjectMembershipCompact)])));
    }
    return result;
  }
        ...
        case 'data':
          result.data.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [
                const FullType(ProjectMembershipCompact)
              ])) as BuiltList<Object>);
          break;
      }
    }
...
class _$InlineResponse20013 extends InlineResponse20013 {
  @override
  final BuiltList<ProjectMembershipCompact> data;
  ...
  _$InlineResponse20013._({this.data}) : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is InlineResponse20013 && data == other.data;
  }
...
class InlineResponse20013Builder
  ...
  ListBuilder<ProjectMembershipCompact> _data;
  ListBuilder<ProjectMembershipCompact> get data =>
      _$this._data ??= new ListBuilder<ProjectMembershipCompact>();
  set data(ListBuilder<ProjectMembershipCompact> data) => _$this._data = data;
  ...
  _$InlineResponse20013 build() {
    ...
    try {
      _$result = _$v ?? new _$InlineResponse20013._(data: _data?.build());
    } catch (_) {
