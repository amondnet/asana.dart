...
part 'project_base.g.dart';

abstract class ProjectBase implements Built<ProjectBase, ProjectBaseBuilder> {
    ...
    factory ProjectBase([updates(ProjectBaseBuilder b)]) = _$ProjectBase;
    static Serializer<ProjectBase> get serializer => _$projectBaseSerializer;
