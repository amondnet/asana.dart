...
Serializer<StoryResponse> _$storyResponseSerializer =
    new _$StoryResponseSerializer();

class _$StoryResponseSerializer implements StructuredSerializer<StoryResponse> {
  @override
  final Iterable<Type> types = const [StoryResponse, _$StoryResponse];
  @override
  final String wireName = 'StoryResponse';

  @override
  Iterable<Object> serialize(Serializers serializers, StoryResponse object,
  ...
  StoryResponse deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new StoryResponseBuilder();
...
class _$StoryResponse extends StoryResponse {
  ...
  factory _$StoryResponse([void Function(StoryResponseBuilder) updates]) =>
      (new StoryResponseBuilder()..update(updates)).build();
  ...
  @override
  StoryResponseBuilder toBuilder() => new StoryResponseBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('StoryResponse')
          ..add('gid', gid)
...
class StoryResponseBuilder
  ...
  @override
  _$StoryResponse build() {
    _$StoryResponse _$result;
    try {
      _$result = _$v ??
          new _$StoryResponse._(
              gid: gid,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'StoryResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
