...
part 'story_response_all_of.g.dart';

abstract class StoryResponseAllOf implements Built<StoryResponseAllOf, StoryResponseAllOfBuilder> {
    ...
    StoryResponseAllOf._();

    factory StoryResponseAllOf([updates(StoryResponseAllOfBuilder b)]) = _$StoryResponseAllOf;
    static Serializer<StoryResponseAllOf> get serializer => _$storyResponseAllOfSerializer;
