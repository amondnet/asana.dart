...
abstract class TaskBase implements Built<TaskBase, TaskBaseBuilder> {
    ...
    factory TaskBase([updates(TaskBaseBuilder b)]) = _$TaskBase;
    static Serializer<TaskBase> get serializer => _$taskBaseSerializer;
