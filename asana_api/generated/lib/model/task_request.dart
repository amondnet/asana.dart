...
abstract class TaskRequest implements Built<TaskRequest, TaskRequestBuilder> {
    ...
    factory TaskRequest([updates(TaskRequestBuilder b)]) = _$TaskRequest;
    static Serializer<TaskRequest> get serializer => _$taskRequestSerializer;
